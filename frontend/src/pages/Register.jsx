  ...
  return (
    <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_460px] gap-8 items-center max-w-7xl mx-auto w-full px-4 sm:px-6 py-10 sm:py-16 relative">
      <div className="hidden lg:block">
        ...
        <h1 className="wiz-hero-title font-display font-extrabold mb-5">Build a stronger signal before you apply.</h1>
        <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed max-w-xl">
          Create your workspace to scan resumes, map them against target roles, and export cleaner versions.
        </p>
      </div>
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-brand-orange dark:text-orange-400 tracking-tight mb-2">Create Account</h2>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Join us to scan, analyze, and optimize your career potential</p>
        </div>
        ...
        <div className="text-center mt-8 pt-6 border-t border-blue-100 dark:border-slate-700">
          <p className="text-slate-500 dark:text-slate-400 text-xs">
            ...
            <Link to="/login" className="text-brand-indigo dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold transition-colors">
              Log In
            </Link>
          </p>
        </div>
